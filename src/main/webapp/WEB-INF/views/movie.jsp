...
<form id="app">
    ...
    <main role="main" class="container">
        ...
        <div style="padding-top:10px; padding-bottom: 10px; margin-top: 10px; margin-bottom: 10px; border-bottom: 1px solid #bcbcbc; border-top:1px solid #bcbcbc;">
            <form action="" method="get">
                <input type="radio" name="radioWeekOrDay" value="Weekly" checked/>Weekly
                <input type="radio" name="radioWeekOrDay" value="Daily"/>Daily
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('input[name="radioWeekOrDay"]').on('change', function () {
                if (this.value == "Week") {
        ...
        //Datalist에 options data dynamic binding
        InsertDataList = function (arr) {
            var options = '';

            for (var i = 0; i < arr.length; i++) {
                options += '<option value="' + arr[i] + '" />';
            }
            document.getElementById('weeklyData').innerHTML = options;
        }

        //
        GetWeek3Year = function () {
